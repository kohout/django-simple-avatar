...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'simpleavatar_avatar', (
            ...
            ('user', self.gf('django.db.models.fields.related.OneToOneField')(related_name='avatar', unique=True, to=orm['core.User'])),
    ...
    models = {
        ...
        u'simpleavatar.avatar': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'user': ('django.db.models.fields.related.OneToOneField', [], {'related_name': "'avatar'", 'unique': 'True', 'to': u"orm['core.User']"})
        }
    }
